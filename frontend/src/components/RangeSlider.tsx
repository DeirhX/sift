...
import type { NumericFilterKey, UpdateFilter } from '../types'
...
export default function RangeSlider(
  { label, minKey, maxKey, filters, updateFilter, histogram }: RangeSliderProps,
) {
