...
export default defineConfig({
  testDir: './e2e',
  // The real-pipeline suite (real/**) and the large-scale windowing proof
  // (windowing.spec.js) have their own configs; keep this fast run lean.
  testIgnore: ['real/**', 'windowing.spec.js'],
  workers: 1,
  timeout: 30_000,
